...
- **FOLLOW-UP I — consumer-specified retrieval diversity (opt-in `RetrievalPolicy` knobs: `maxPerSource` / MMR; engine stays ranking-pure, no default cap).** → [#15](https://github.com/JesusFilm/jesusfilm-rag/issues/15)
