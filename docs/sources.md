...
|--------|-----|------|--------|---------|---------------------------|
| Jesus Film Project | https://www.jesusfilm.org | HTML | Acquiring | — | **Slice #3** (`slice/jesusfilm-org`), started 2026-05-26. Owned, ~1,200 pages — first source on the new **discovery-crawl** model (FOLLOW-UP F): `sitemap_index.xml` seed → allow∧articleHints → drop block. Key `jesusfilm-org` (per jfa). See `docs/slices/jesusfilm-org.md`. |
