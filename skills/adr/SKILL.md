---
name: adr
description: "Draft or complete an Architecture Decision Record for a decision made in the current change, following this repo's docs/decisions/ template. Surveys the working diff, picks the next NNNN, writes Context/Decision/Alternatives-rejected/Consequences, marks Status and Related, updates the locked-decisions index, cites the ADR at the governed code seam, and commits it. Invoke explicitly as $adr after accepting an ADR checkpoint, optionally with a one-line decision."
---
